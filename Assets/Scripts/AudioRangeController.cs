...
public class AudioRangeController : MonoBehaviour
{
    ...
    [SerializeField] private float minSoundDistance = 10;
    ...
    private void Update()
    {
        ...
        float t = Mathf.Clamp01(1 - (distance / minSoundDistance));
    ...
    private void OnDrawGizmos()
    {
        if (showGizmo)
        {
            ...
            Gizmos.DrawWireSphere(transform.position, minSoundDistance);
        }
    }
}
