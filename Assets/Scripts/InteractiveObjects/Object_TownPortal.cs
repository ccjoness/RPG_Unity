...
public class Object_TownPortal : MonoBehaviour, ISaveable
{
    public static Object_TownPortal instance;
    public bool isActive {get; private set;}
    
    [SerializeField] private Vector2 defaultPosition;
    public string townSceneName = "Level_0";
    ...
    private void Awake()
    {
        ...
        transform.position = new Vector3(99999, 99999);
    }
