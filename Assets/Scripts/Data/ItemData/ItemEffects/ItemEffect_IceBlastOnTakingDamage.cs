...
[CreateAssetMenu(menuName = "RPG Setup/Item Data/Item Effect/Ice Blast On Damage", fileName = "Item Effect Data - Ice Blast On Damage")]
public class ItemEffect_IceBlastOnTakingDamage : ItemEffect_DataSO
{
    ...
    {
        effectDescription = $"When you take damage and your health falls below {healthPercentTrigger * 100}%, unleash a cold explosion dealing {iceDamage} ice damage to nearby  enemies. \nCooldown {cooldown}s.";
    }
